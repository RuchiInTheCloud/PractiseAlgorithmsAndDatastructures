...
public class _40_PathSum2 {
    ...
    class Solution {
        ...
        private void pathSum(TreeNode root, int targetSum, int currentSum, List<Integer> path,
            ...
            if (currentSum == targetSum && root.left == null && root.right == null) {
                ...
                pathSum(root.left, targetSum, currentSum, path, result);
                pathSum(root.right, targetSum, currentSum, path, result);
            }
